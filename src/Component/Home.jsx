        ...
        <div className='p-12 m-12 flex justify-center items-center'>
            ...
            <div className='  w-[70%] h-4/5  flex justify-center items-center flex-col'>
                    ...
                    <div className='mt-5 flex' >
                        ...
                        px-5 py-4 rounded-full hover:brightness-125
                         hover:scale-110 transition ease-in-out cursor-pointer'><a href={resume}>My Resume</a> <img className='h-7 px-3' src={dowld} alt="" /></button>
                    </div>
            </div>
